...
ISEStep( "ngdbuild",
         "-intstyle ise -p xc6slx9ftg256-2 -dd _ngo -uc \"HA.ucf\" \"HA.edf\"" );
ISEStep( "map",
         "-intstyle pa -w \"HA.ngd\"" );
ISEStep( "par",
         "-intstyle pa \"HA.ncd\" -w \"HA_routed.ncd\"" );
ISEStep( "trce",
         "-intstyle ise -o \"HA.twr\" -v 30 -l 30 \"HA_routed.ncd\" \"HA.pcf\"" );
ISEStep( "xdl",
         "-secure -ncd2xdl -nopips \"HA_routed.ncd\" \"HA_routed.xdl\"" );
